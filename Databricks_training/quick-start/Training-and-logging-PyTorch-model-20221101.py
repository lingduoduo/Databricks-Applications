...
# MAGIC 
# MAGIC 1. Create a GPU-enabled cluster specifying Python 3.
# MAGIC 1. If you are not running Databricks Runtime for Machine Learning, you must install the required library.
