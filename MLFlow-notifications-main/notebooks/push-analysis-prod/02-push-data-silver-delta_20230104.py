...
# MAGIC %md 
# MAGIC Experiment Results - https://dbc-6e4f74ab-0d7d.cloud.databricks.com/?o=1615526246868093#mlflow/experiments/3730494584728171
# MAGIC 
# MAGIC `ValueError: Unknown format code 'f' for object of type 'str'`
...
bronze_df_ratios = bronze_df_neg.withColumn('ratio', F.lit(70/tot)).groupBy('broadcaster_id').agg(F.sum('ratio').alias('ratio'))
...
# MAGIC %md
# MAGIC Experiment Results - https://dbc-6e4f74ab-0d7d.cloud.databricks.com/?o=1615526246868093#mlflow/experiments/3358613615173236
