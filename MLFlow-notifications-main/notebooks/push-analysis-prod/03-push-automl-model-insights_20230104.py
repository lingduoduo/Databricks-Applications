...
def objective(params):
    with mlflow.start_run(experiment_id="3358613615173236", run_name="lightgbm") as mlflow_run:
...
print(f"%md [Link to model run page](#mlflow/experiments/3358613615173236/runs/{ mlflow_run.info.run_id }/artifactPath/model)")
