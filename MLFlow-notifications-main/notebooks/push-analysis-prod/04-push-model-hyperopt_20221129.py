...
with mlflow.start_run(experiment_id="3345621877634310", run_name="lightgbm") as mlflow_run:
...
supported_cols = ["broadcaster_id", "utc_day_of_week", "utc_hour", "network_user_id"]
...
search_space = {
     ...
     'num_leaves': scope.int(hp.quniform('num_leaves', 20, 500, 1)),
