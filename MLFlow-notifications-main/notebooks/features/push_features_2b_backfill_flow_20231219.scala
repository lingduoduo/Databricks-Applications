...
// MAGIC DROP TABLE IF EXISTS ml_push.temp_push_demographics;
...
// MAGIC dbutils.fs.rm("dbfs:/mnt/tmg-prod-ml-outputs/push_data/temp/temp_push_demographics/",True)
...
// MAGIC %sql
// MAGIC CREATE OR REPLACE TABLE ml_push.temp_push_demographics(
...
// MAGIC     registration_ts timestamp,
// MAGIC     age int,
// MAGIC     gender string,
// MAGIC     country string,
// MAGIC     broadcast_search_count_24h int,
// MAGIC     search_user_count_24h int,
// MAGIC     search_match_count_24h int,
// MAGIC     view_count_24h int,
// MAGIC     view_end_count_24h int,
// MAGIC     gift_count_24h int,
// MAGIC     from_user_gender string,
// MAGIC     from_user_age int,
// MAGIC     from_user_country string)
// MAGIC USING DELTA
// MAGIC  PARTITIONED BY (utc_hour)  
// MAGIC     LOCATION  'dbfs:/mnt/tmg-prod-ml-outputs/push_data/temp/temp_push_demographics/'
...
// MAGIC val partitionWindow2 = Window.partitionBy($"member_id", $"network").orderBy($"birth_date", $"gender", $"country", $"registration_ts")
// MAGIC 
// MAGIC 
...
// MAGIC                     service_name,
// MAGIC                     device_type
// MAGIC                  FROM   datalake_prod.s_tmg_notification 
...
// MAGIC                           $"send.send_ts" < $"open.open_ts" &&
// MAGIC                           $"open.open_ts" <= $"send.max_time", "leftouter").distinct()  
// MAGIC 
// MAGIC 
...
// MAGIC   COALESCE(i.gender, j.gender) from_user_gender,
// MAGIC   COALESCE(get_age(a.send_ts, from_unixtime(i.birth_date/1000)), get_age(a.send_ts, from_unixtime(j.birth_date/1000))) from_user_age,
// MAGIC   COALESCE(i.country, j.country) from_user_country
// MAGIC from 
...
// MAGIC  left join ml_push.temp_user_profile_snapshot h on  a.user_id=h.member_id and a.common__network=h.network and h.network='meetme'
// MAGIC  left join ml_push.temp_user_profile_snapshot i on  a.from_user_id=i.member_id and a.from_user_network=i.network and i.network='meetme'
// MAGIC  left join ml_push.temp_user_profile_snapshot j on  a.from_user_id=j.member_id and j.network!='meetme' and i.member_id is null
// MAGIC )
// MAGIC  INSERT INTO 
// MAGIC ml_push.temp_push_demographics(
// MAGIC     utc_hour,
// MAGIC     send_ts ,
// MAGIC     user_id ,
// MAGIC     network_user_id ,
...
// MAGIC %sql
// MAGIC DROP TABLE IF EXISTS ml_push.push_demographics

// COMMAND ----------

// MAGIC %python
// MAGIC ##clear out temp tables
// MAGIC dbutils.fs.rm("dbfs:/mnt/tmg-prod-ml-outputs/push_data/temp/push_demographics/",True)
...
// MAGIC %sql
// MAGIC CREATE OR REPLACE TABLE ml_push.push_demographics(
// MAGIC     utc_hour TIMESTAMP,
// MAGIC     send_ts TIMESTAMP,
// MAGIC     user_id STRING,
// MAGIC     network_user_id STRING,
...
// MAGIC     from_user_age int,
// MAGIC     from_user_country string,
// MAGIC     user_account_age long)
// MAGIC USING DELTA
// MAGIC  PARTITIONED BY (utc_hour)  
// MAGIC     LOCATION  'dbfs:/mnt/tmg-prod-ml-outputs/push_data/temp/push_demographics/'

// COMMAND ----------

// MAGIC %sql
// MAGIC insert into ml_push.push_demographics(
// MAGIC     utc_hour ,
// MAGIC     send_ts ,
// MAGIC     user_id ,
// MAGIC     network_user_id ,
...
// MAGIC     from_user_age ,
// MAGIC     from_user_country,
// MAGIC     get_account_age(send_ts, registration_ts) user_account_age
// MAGIC     from ml_push.temp_push_demographics
// MAGIC     
// MAGIC     
