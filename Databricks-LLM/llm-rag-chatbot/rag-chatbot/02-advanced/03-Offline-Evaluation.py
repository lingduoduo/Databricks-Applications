...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=local&notebook=%2F02-advanced%2F03-Offline-Evaluation&demo_name=llm-rag-chatbot&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Fllm-rag-chatbot%2F02-advanced%2F03-Offline-Evaluation&version=1">
...
# MAGIC %md-sandbox
# MAGIC ### Creating an external model endpoint with Open AI as a judge
# MAGIC
    ...
    config={
        "served_entities": [{
            "external_model": {
                ...
                "task": "llm/v1/chat",
                "openai_config": {
                    "openai_api_key": "{{secrets/dbdemos/openai_api_key}}"
                }
            }
        }]
    }
