...
job_json = {
        ...
        "tasks": [
            ...
            },
            {
                "job_cluster_key": "segmentation_cluster",
                "notebook_task": {
                    "notebook_path": f"03_Clustering"
                },
                "task_key": "segmentation_03",
                "depends_on": [
                    {
                        "task_key": "segmentation_02"
                    }
            ...
            },
            {
                "job_cluster_key": "segmentation_cluster",
                "notebook_task": {
                    "notebook_path": f"04_Profiling"
                },
                "task_key": "segmentation_04",
                "depends_on": [
                    {
                        "task_key": "segmentation_03"
                    }
