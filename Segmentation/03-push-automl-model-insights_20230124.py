...
# MAGIC - Compare trials in the [MLflow experiment](#mlflow/experiments/3358613615173236)
# MAGIC - Navigate to the parent notebook [here](#notebook/3358613615173237) (If you launched the AutoML experiment using the Experiments UI, this link isn't very useful.)
...
def objective(params):
    with mlflow.start_run(experiment_id="2695937635426936", run_name="lightgbm") as mlflow_run:
...
print(f"%md [Link to model run page](#mlflow/experiments/2695937635426936/runs/{ mlflow_run.info.run_id }/artifactPath/model)")
